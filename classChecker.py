...
while True:
    ...
    url = "https://courses.students.ubc.ca/cs/courseschedule?pname=subjarea&tname=subj-section&dept=ASIA&course=326&section=001b "
    ...
    # but if the word "Google" occurs any other number of times,
        ...
        fromaddr = 'classCheckers@gmail.com'
        # set the 'to' addresses,
        toaddrs = ['iswmourad@hotmail.com']

        # setup the email server,
        server = smtplib.SMTP('smtp.gmail.com', 587)
        server.starttls()
        # add my account login name and password,
        server.login("classCheckers@gmail.com", "mourad96")
